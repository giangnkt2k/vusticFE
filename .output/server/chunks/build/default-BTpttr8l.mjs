import { p as _sfc_main$4$1, N as __nuxt_component_1$1, g as _sfc_main$b, d as useAppConfig, t as tv, J as isArrayOfArray, k as _sfc_main$e, _ as _sfc_main$g, K as get, f as _sfc_main$c, L as pickLinkProps, M as _sfc_main$d, H as useButtonGroup, s as useComponentIcons, I as usePortal } from './server.mjs';
import { defineComponent, unref, mergeProps, withCtx, renderSlot, defineAsyncComponent, createVNode, computed, useSlots, toRef, resolveDynamicComponent, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, withModifiers, Fragment, renderList, toHandlers, useSSRContext } from 'vue';
...
import { _ as _sfc_main$7, a as _sfc_main$2$1 } from './DropdownMenu-BLV8L53p.mjs';
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.3.3_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@0.3.2_em_2b3b2ac436a2d8473dd8078f8c127796/node_modules/@nuxt/ui/dist/runtime/components/Badge.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.3.3_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@0.3.2_em_2b3b2ac436a2d8473dd8078f8c127796/node_modules/@nuxt/ui/dist/runtime/components/Popover.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.3.3_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@0.3.2_em_2b3b2ac436a2d8473dd8078f8c127796/node_modules/@nuxt/ui/dist/runtime/components/Tooltip.vue");
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$e, mergeProps({
                    key: 0,
                    size: item.ui?.linkLeadingAvatarSize || props.ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize()
                  }, item.avatar, {
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                              ...
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$5, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink), {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$d, mergeProps({ ref_for: true }, childSlotProps, {
                                                        ...
                                                        return [
                                                          createVNode(_sfc_main$d, mergeProps({ ref_for: true }, childSlotProps, {
                                                            class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                          }), {
                                                            default: withCtx(() => [
                                                              childItem.icon ? (openBlock(), createBlock(_sfc_main$g, {
                                    ...
                                    default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$d, mergeProps(slotProps, {
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$d, mergeProps(slotProps, {
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$5, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$d, mergeProps({ key: 2 }, slotProps, {
                                    class: ui.value.link({ class: [props.ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: __props.orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                      createVNode(unref(ReuseLinkTemplate), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(NavigationMenuLink), {
                                              ...
                                              default: withCtx((_3, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$d, mergeProps({ ref_for: true }, childSlotProps, {
                                                    class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                  }), {
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.3.3_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@0.3.2_em_2b3b2ac436a2d8473dd8078f8c127796/node_modules/@nuxt/ui/dist/runtime/components/NavigationMenu.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_2_lazy = defineAsyncComponent(() => import('./Slideover-Ch8aghCC.mjs').then((c) => c.default || c));
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppLogo = __nuxt_component_1$1;
      const _component_UNavigationMenu = _sfc_main$3;
      const _component_LazyUSlideover = __nuxt_component_2_lazy;
      const _component_UButton = _sfc_main$b;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-col items-center gap-4" }, _attrs))}><div class="flex items-center justify-center">`);
      ...
      _push(ssrRenderComponent(_component_LazyUSlideover, {
        side: "left",
        title: "Menu",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UDropdownMenu, { items: actions }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, {
              color: "neutral",
              variant: "ghost",
              label: unref(dropdownLabel),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ProfileMenu.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "ProfileMenu" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProfileMenu = __nuxt_component_1;
      const _component_UContainer = _sfc_main$4$1;
      if (unref(isAuthenticated)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 flex overflow-hidden" }, _attrs))}><div class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">`);
        _push(ssrRenderComponent(_component_NavBar, null, null, _parent));
        _push(`</div><div class="relative flex flex-col min-w-0 min-h-svh lg:not-last:border-r lg:not-last:border-default flex-1"><div class="h-(--ui-header-height) shrink-0 flex items-center justify-end border-b border-default px-4 sm:px-6 gap-1.5">`);
        _push(ssrRenderComponent(_component_ProfileMenu, null, null, _parent));
        _push(`</div>`);
        _push(ssrRenderComponent(_component_UContainer, { class: "flex flex-col gap-4 sm:gap-6 flex-1 overflow-y-auto p-4 sm:p-6" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
//# sourceMappingURL=default-BTpttr8l.mjs.map
