...
export type SanctumFetchOptions<R extends ResponseType = ResponseType, T = unknown> = Omit<FetchOptions<R, T>, 'baseUrl' | 'credentials' | 'redirect' | 'retry' | 'onRequest' | 'onRequestError' | 'onResponse' | 'onResponseError'>;
